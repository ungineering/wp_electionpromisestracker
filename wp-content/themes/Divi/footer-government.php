        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <p class="text-muted">Maintained by <a href="http://ungineering.com/" target="_blank">Ungineering</a></p>
                    </div>
                    <div class="col-md-4">
                        <p class="text-muted">Inspired By <a href="https://www.trudeaumetre.ca/" target="_blank" rel="nofollow">TrudeauMetre</a></p>
                    </div>
                    <div class="col-md-4">
                        <p class="text-muted">Cloned from <a href="https://trumptracker.github.io/"" target="_blank" rel="nofollow">Trump Tracker</a></p>
                    </div>
                </div>
            </div>
        </footer>
